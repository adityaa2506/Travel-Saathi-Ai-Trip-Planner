        ...
        <div className='sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10'>
            ...
            <div className='flex flex-col gap-8 mt-20'>
                ...
                <div>
                    ...
                    <Input className="border border-gray-300 block w-full p-1.5 rounded" placeholder={'Ex. 3'} type="number"
            ...
            <div className="flex my-10 justify-end"><Button className="pl-10 pr-10 pt-5 pb-5" onClick={onGenerateTrip}>Generate</Button></div>
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            <div class="flex items-center">
                                ...
                                <div class="text-gray-800 font-bold font-serif text-[25px]">Travel Saathi</div>
                            </div>
                            <h2 className='font-bold text-lg mt-7'>Sign In With Google</h2>
                            <p>sign In TO tThe App With Google Authentication Securely</p>
                            <Button
                                onClick={login}
                                className="w-full mt-5 flex gap-4 items-center"><FcGoogle className='h-11 w-11' /> Sign In as Google </Button>
                        </DialogDescription>
                    </DialogHeader>
                </DialogContent>
            </Dialog>
